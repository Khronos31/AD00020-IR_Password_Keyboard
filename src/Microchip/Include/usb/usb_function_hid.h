...
typedef struct { BYTE report[HID_RPT01_SIZE]; } HID_REPORT01;
extern ROM HID_REPORT01 hid_rpt01;
typedef struct { BYTE report[HID_RPT02_SIZE]; } HID_REPORT02;
extern ROM HID_REPORT02 hid_rpt02;
typedef struct { BYTE report[HID_RPT03_SIZE]; } HID_REPORT03;
extern ROM HID_REPORT03 hid_rpt03;
typedef struct { BYTE report[HID_RPT04_SIZE]; } HID_REPORT04;
extern ROM HID_REPORT04 hid_rpt04;
#endif
